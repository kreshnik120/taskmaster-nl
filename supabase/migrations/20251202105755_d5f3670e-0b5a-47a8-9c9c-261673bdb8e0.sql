...
-- Fix log_recruitment_events trigger to handle professional_clients without org_id column
-- professional_clients doesn't have org_id, need to fetch it from professionals table
...
BEGIN
  ...
  ELSIF TG_TABLE_NAME IN ('professional_clients', 'professional_client_matches') THEN
    -- Fetch org_id from professionals table via professional_id
