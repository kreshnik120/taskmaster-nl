    ...
    extend: {
      ...
      colors: {
        ...
        tab: {
          ...
          facturatie: {
            50: "hsl(var(--tab-facturatie-50))",
            100: "hsl(var(--tab-facturatie-100))",
            200: "hsl(var(--tab-facturatie-200))",
            300: "hsl(var(--tab-facturatie-300))",
            400: "hsl(var(--tab-facturatie-400))",
            500: "hsl(var(--tab-facturatie-500))",
            600: "hsl(var(--tab-facturatie-600))",
            700: "hsl(var(--tab-facturatie-700))",
            800: "hsl(var(--tab-facturatie-800))",
            900: "hsl(var(--tab-facturatie-900))",
            DEFAULT: "hsl(var(--tab-facturatie-500))",
          },
        },
      },
      borderRadius: {
